...
(function(global) {
  ...
  const PHRASE_TRANSLATIONS = {
    ...
    "Login Securely": {"hi":"सुरक्षित लॉगिन करें","te":"సురక్షితంగా లాగిన్ అవ్వండి","ta":"பாதுகாப்பாக உள்நுழைக","mr":"सुरक्षित लॉग इन करा","bn":"নিরাপদে লগইন করুন","kn":"ಸುರಕ್ಷಿತವಾಗಿ ಲಾಗಿನ್ ಆಗಿ"},
