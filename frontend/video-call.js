...
(function(global) {
  ...
  class VideoCallController {
          ...
          try {
            this.localStream = await navigator.mediaDevices.getUserMedia({
              audio: {
                ...
                channelCount: 1 // Mono stream: 50% packet weight, sub-40ms latency
              },
              video: {
    ...
    toggleVideoFit() {
      ...
      const currentFit = remoteVideo.style.objectFit || 'cover';
      ...
      if (btn) btn.innerHTML = newFit === 'contain' ? '🔍 <span>Fill</span>' : '🔍 <span>Fit</span>';
      if (global.toast) global.toast(newFit === 'contain' ? '🔍 Video Fit (Full Frame Visible)' : '🔍 Video Fill (Edge to Edge)');
    }
        ...
        <div style="width:100vw;height:100vh;max-width:100%;max-height:100%;background:#020617;display:flex;flex-direction:column;overflow:hidden;position:relative;">
          ...
          <div style="position:absolute;top:0;left:0;right:0;background:linear-gradient(180deg, rgba(15,23,42,0.92) 0%, rgba(15,23,42,0.6) 70%, transparent 100%);backdrop-filter:blur(8px);padding:10px 16px;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:8px;z-index:40;">
            ...
            <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;">
              ...
              <button id="btnToggleFit" onclick="videoCallController.toggleVideoFit()" style="background:rgba(0,0,0,0.5);color:#cbd5e1;border:1px solid rgba(255,255,255,0.15);font-size:11px;font-weight:700;padding:4px 10px;border-radius:20px;cursor:pointer;">🔍 <span>Fit</span></button>
          ...
          <!-- FULL EDGE-TO-EDGE VIDEO STAGE -->
          <div style="flex:1;width:100%;height:100%;position:relative;background:#000000;display:flex;align-items:center;justify-content:center;overflow:hidden;">
            
            <!-- NATIVE REMOTE VIDEO ELEMENT (FULLSCREEN ADAPTIVE) -->
            ...
            <!-- UNMUTED DEDICATED REMOTE AUDIO PLAYBACK -->
            ...
            <div id="localPipContainer" style="position:absolute;bottom:85px;right:14px;width:clamp(110px, 22vw, 150px);height:clamp(80px, 16vw, 110px);background:#1e293b;border:2px solid #0284c7;border-radius:12px;overflow:hidden;box-shadow:0 8px 24px rgba(0,0,0,0.8);z-index:25;transition:all 0.3s ease;">
