...
(function(global) {
  ...
  const CLINICAL_KB = [
    ...
    {
      keywords: ['cut', 'wound', 'bleeding', 'injury', 'chot', 'rakta', 'ghav', 'trauma', 'burn', 'jalan', 'blood', 'laceration', 'scraped', 'cut in leg', 'cut in arm', 'bleeding leg'],
  ...
  class AiHealthBotController {
    ...
    setLanguage(lang) {
      ...
      if (global.swasthyaAi && typeof global.swasthyaAi.setLanguage === 'function') {
        global.swasthyaAi.setLanguage(lang);
      }
    }
