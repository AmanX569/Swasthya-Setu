...
// Inline JS files
const jsFiles = ['supabase-config.js', 'supabase-service.js', 'api-client.js', 'locations-data.js', 'store.js', 'i18n.js', 'gps-tracker.js', 'video-call.js', 'patient.js', 'doctor.js', 'worker.js', 'admin.js', 'swasthya-ai-chat.js'];
let inlinedJs = '';
