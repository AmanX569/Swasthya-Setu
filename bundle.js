...
// Inline JS files
const jsFiles = ['supabase-config.js', 'supabase-service.js', 'store.js', 'i18n.js', 'gps-tracker.js', 'video-call.js', 'ai-health-bot.js', 'patient.js', 'doctor.js', 'worker.js', 'admin.js'];
let inlinedJs = '';
